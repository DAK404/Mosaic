...
public final class AddUser 
{
	 ...
	 *
	 * @param SecureBoot    : Initializes the SecureBoot variable
	...
	*/
	private boolean GetCurrentCredentials()throws Exception
	{
		...
		String CurrentPassword=sha.encodedString(String.valueOf(console.readPassword()));
		System.out.print("Security Key: ");
		String CurrentKey=sha.encodedString(String.valueOf(console.readPassword()));
		API.Anima.LoginAPI login=new API.Anima.LoginAPI(curUser, CurrentPassword, CurrentKey);
		return login.status();
	}
